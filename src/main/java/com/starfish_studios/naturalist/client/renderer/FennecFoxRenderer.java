...
public class FennecFoxRenderer<R extends LivingEntityRenderState & GeoRenderState> extends GeoEntityRenderer<FennecFox, R> {
    public static final DataTicket<Boolean> IS_BABY = DataTicket.create("fennecfox_is_baby", Boolean.class);
    ...
    @Override
    public void extractRenderState(FennecFox entity, R renderState, float partialTick) {
        super.extractRenderState(entity, renderState, partialTick);
        renderState.addGeckolibData(FennecFoxModel.FENNEC_VARIANT, entity.getVariant());
